...
export const articles: Article[] = [
  ...
  },
  {
    ...
    excerpt: l("5 月 21 日小米人车家全生态发布会上，YU7 GT 以 738 kW（约 990 马力）、2.92 秒破百、纽北 SUV 圈速纪录登场；YU7 系列形成 23.35-38.99 万元五款阵容。", "At the 21 May Human × Car × Home event, the YU7 GT arrived with 738 kW (about 990 hp), 0–100 km/h in 2.92 s and the Nürburgring SUV record; the YU7 line now spans five trims from ¥233,500 to ¥389,900."),
    date: "2026-05-21",
    readMinutes: 4,
    image: "/images/vehicles/xiaomi-yu7-gt/hero.jpg",
    body: [
      l("小米 YU7 GT 官方指导价 38.99 万元，大满配 42.99 万元。新车搭载小米 V8s EVO 超级电机与自研碳化硅功率模块，前 288 kW + 后 450 kW，综合 738 kW（约 990 马力），最高车速 300 km/h，CLTC 续航 705 km。", "The YU7 GT lists at ¥389,900 (¥429,900 fully specified). It pairs Xiaomi V8s EVO motors with in-house SiC power modules — 288 kW front, 450 kW rear, 738 kW (about 990 hp) combined — for a 300 km/h top speed and 705 km CLTC range."),

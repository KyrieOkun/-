...
export function TripPlanner({ cities, majorCityIds, vehicles, initialVehicle, stations }: { cities: City[]; majorCityIds?: string[]; vehicles: VehicleSummary[]; initialVehicle?: string; stations: MapStation[] }) {

    ...
    <div className="pt-14">
      <section className="border-b border-line bg-cloud">
        <Container className="py-12 lg:py-16">
          ...
          <p className="mt-4 max-w-2xl text-pretty text-base leading-7 text-slate sm:text-lg">{t.connect.serviceSubtitle}</p>
        </Container>
      </section>
      <Container className="py-12 pb-24">
        <ServiceForm vehicles={vehicles.map(toVehicleSummary)} stores={stores} cities={cities} />
      </Container>
    </div>
  );
}
